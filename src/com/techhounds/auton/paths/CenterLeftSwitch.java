...
public class CenterLeftSwitch extends CommandGroup {
    ...
    public CenterLeftSwitch() {
    	...
    	// drive up to switch
    	addSequential(new DriveAngle(-40, 0.4, 0), 1);
...
////    	addSequential(new TurnToAngleGyro(-30), 1);
    	...
    	addSequential(new DriveStraight(-65, -0.6, -30), 3);
    	addSequential(new DriveStraight(-20, -0.4, -30), 2);
    	
////    	// grab another one
    	addSequential(new TurnToAngleGyro(-3), 1.5);
    	addParallel(new GrabCube(), 3);
    	addParallel(new IntakeUntilDetected(), 3);
    	addSequential(new DriveStraightUntilDetected(40, 0.5), 1);
    	addSequential(new DriveStraightUntilDetected(10, 0.1), 0.5);
//    	
