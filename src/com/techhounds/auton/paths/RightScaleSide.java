...
public class RightScaleSide extends CommandGroup {
    ...
    public RightScaleSide() {
    	...
    	addSequential(new DelayedCommand(new TurnToAngleGyro(-90), .7), 2);
    	addSequential(new DriveStraightRamp(-20, -0.4, 0), 1);
    	addParallel(new SetTiltPosition(Tilt.POS_DOWN));
    	addSequential(new DelayedCommand(new SetElevatorPosition(ElevatorPosition.SCALE), .9));
